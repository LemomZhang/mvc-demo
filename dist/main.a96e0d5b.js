...
var localStorage_number = localStorage.getItem('output.number');
...
$actions.on('click', 'button', function (e) {
  ...
  if (action === '+1') {
    ...
    var _number = parseInt($number.text());

    _number -= 1;
    localStorage.setItem('output.number', _number);
    $number.text(_number);
  } else if (action === '×2') {
    var _number2 = parseInt($number.text());

    _number2 *= 2;
    localStorage.setItem('output.number', _number2);
    $number.text(_number2);
  } else {
    var _number3 = parseInt($number.text());

    _number3 /= 2;
    localStorage.setItem('output.number', _number3);
    $number.text(_number3);
  }
});
...
//# sourceMappingURL=main.a96e0d5b.js.map